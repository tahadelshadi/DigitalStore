  ...
  return (
    <section id="newArrivals">
      ...
      <div className="grid md:grid-rows-3 md:grid-flow-col  gap-4">
        <div className="md:row-span-3 xs:col-span-4 flex flex-col justify-between gap-4 bg-neutral-100 px-6 pt-6">
        ...
        {Array(3)
          ...
          .map((x, idx) => (
            <Link
              className="col-span-4 flex flex-row border border-gray-200 p-4  gap-8"
              href={"/"}
              key={idx}>
              <div className="items-center border border-gray-200">
                <Image
                  className=""
                  src={s24}
                  width={150}
